...
function NavigationSidebar() {
  return (
    <div className="mb-8 w-full md:mb-0 md:w-60">
      <div className="no-scrollbar md:sticky md:top-16 md:h-[calc(100vh-64px)] md:overflow-y-auto md:overflow-x-hidden">
        <div className="md:py-8">
          ...
          <div className="no-scrollbar -mx-4 flex flex-nowrap overflow-x-scroll px-4 md:block md:space-y-3 md:overflow-auto">
            {/* Group 1 */}
            <div>
              <div className="mb-3 text-xs font-semibold uppercase text-slate-400 md:sr-only">
                Menu
              </div>
              <ul className="mr-3 flex flex-nowrap md:mr-0 md:block">
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a
                    className="flex items-center whitespace-nowrap rounded bg-white px-2.5 py-2"
                    href="#0"
                  >
                    <svg
                      className="mr-2 h-4 w-4 shrink-0 fill-current text-indigo-500"
                      viewBox="0 0 16 16"
                    >
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  ...
                  >
                    <svg
                      className="mr-2 h-4 w-4 shrink-0 fill-current text-slate-400"
                      viewBox="0 0 16 16"
                    >
