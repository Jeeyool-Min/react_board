    ...
    <>
      ...
      <div className="bg-white shadow-md rounded border border-slate-200 p-5">
        ...
        <footer className="flex items-center space-x-4">
          {/* Like button */}
          <button type="button" className="flex items-center text-slate-400 hover:text-indigo-500">
        ...
        <div className="mt-5 pt-3 border-t border-slate-200">
          ...
          <div className="flex justify-between space-x-2">
            <div className="text-sm text-slate-500">
              <span className="font-medium text-slate-600">2</span>
              {' '}
              of
              {' '}
      ...
      <div className="bg-white shadow-md rounded border border-slate-200 p-5">
        ...
        <div className="text-sm text-slate-800 space-y-2 mb-5">
          ...
          <div className="relative flex items-center justify-center !my-4">
            ...
            <button type="button" className="absolute group">
