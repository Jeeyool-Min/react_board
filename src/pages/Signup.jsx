      ...
      <div className="relative md:flex">
        ...
        <div className="md:w-1/2">
          ...
          setEmail(e.target.value);
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="name">First Name <span className="text-rose-500">*</span></label>
                    <input id="first_name" className="form-input w-full" type="text" onChange={(e) => {
          setFirstName(e.target.value);
        }}/>
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="name">Last Name <span className="text-rose-500">*</span></label>
                    <input id="last_name" className="form-input w-full" type="text" onChange={(e) => {
          ...
          setPassword(e.target.value);
                ...
                <div className="flex items-right justify-end mt-6">
                  ...
                  <Link className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3 whitespace-nowrap" onClick={handleSignup}>Sign Up</Link>
                </div>
              </form>
              {/* Footer */}
        ...
        {/* Image */}
        <div className="hidden md:block absolute inset-y-0 right-0 md:w-1/2" aria-hidden="true">
